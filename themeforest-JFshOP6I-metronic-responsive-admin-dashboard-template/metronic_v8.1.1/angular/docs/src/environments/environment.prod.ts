  ...
  changelogs: [
    {
      ...
      changelog: {
        new: [
          'Added new Angular <code>demo5</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo5">Preview</a>',
          'Added new Angular <code>demo7</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo7">Preview</a>',
          'Added <code>runtime switcher</code> between <code>dark</code> and <code>light</code> modes. <a href="https://preview.keenthemes.com/metronic8/angular/demo1">Preview</a>',
          'Modals examples. <a href="https://preview.keenthemes.com/metronic8/angular/docs/modals">Preview</a>',
        ],
        update: [
          'Update Angular version to <code>14</code>. <a href="https://update.angular.io/?l=3&v=13.0-14.0">https://update.angular.io/?l=3&v=13.0-14.0</a>',
          'Update and sync core assets from the HTML version.',
        ],
        fix: [
          'Fix <code>dropdown</code> behaviour issues.',
          'Fix <code>error</code> components <code>back</code> function disable all menus.',
          'Fix <code>ng lint</code> command issues.',
          'Fix <code>Splash screen</code>. Smooth transitions and avoiding blinks till the main application loads.',
        ],
      },
    },
    {
    ...
    },
    {
      ...
      changelog: {
        ...
        update: ['Update and sync core assets from the HTML version.'],
        fix: [],
      },
    },
    {
      ...
      changelog: {
        new: [],
        update: ['Layout improvements', 'Docs improvements'],
        fix: [],
      },
    },
    {
    ...
    },
    {
      ...
      changelog: {
        new: ['Added engage toolbar.', 'Added demo topbar search.'],
        update: ['Update tooltip for the dummy links.'],
        fix: ['Fixed main font family loading.'],
      },
    },
    {
      version: 'v8.0.33',
    ...
    },
    {
      ...
      changelog: {
        new: [],
        update: [],
        fix: ['Fixed aside menu config in the layout builder.'],
      },
    },
    {
      version: 'v8.0.26',
    ...
    },
    {
      ...
      changelog: {
        new: ['Added new <code>dark mode</code> in demo1'],
        update: [],
        fix: ['Fixed minimize aside icon.', 'Fixed <code>KTMenu</code> flip.'],
      },
    },
    {
      version: 'v8.0.24',
